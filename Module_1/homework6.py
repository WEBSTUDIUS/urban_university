...
print(my_dict)
print(my_dict['Stevie W.'])
print(my_dict.get('Arnold', 'Did you mean Arnold Sch.? =)'))
...
# my_set
my_set = {1, 1, 1, 1, 2, 2, 2, 3, 3, 3, True, 'string', 'string', 2.2, 2.2}
print(my_set)
my_set.update(['qwerty', 'asd'])  # or we can use 'add' step-by-step
print(my_set)
my_set.discard(1)
print(my_set)
